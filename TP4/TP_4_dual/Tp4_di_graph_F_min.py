...
def set_graphe(G, M, C, BigM, li):
    ...
    return probmin, variable_x, variable_y
...
def solve_graphe(G, M, C, BigM, li):
    ...
    # ------------------------------------------------------------------------ #
    probmin, variable_x, variable_y = set_graphe(G, M, C, BigM, li)
    ...
    # ------------------------------------------------------------------------ #
    print_log_output(probmin, variable_x)


# ============================================================================ #
#                                   UTILITIES                                  #
# ============================================================================ #
def print_log_output(probmin: LpProblem, variable_x):
